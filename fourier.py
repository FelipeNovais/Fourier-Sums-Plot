...
#PLOTING
ax.plot(x, y) #Fourier terms
ax.step([-2 * pi, -pi],[1, 1],'r', [-pi, 0],[0, 0],'r', [0, pi],[1, 1],'r', [pi, 2 * pi],[0, 0], 'r') #f(x)
ax.scatter(x2, y2, s = 30, c = 'r') #f(x) left boundaries
